...
sub new {
    ...
    $self->{cx_repwin} = Wx::CheckBox->new($self, wxID_ANY, _T("Rapporten in hetzelfde venster"), wxDefaultPosition, wxDefaultSize, );
    $self->{cx_updatecheck} = Wx::CheckBox->new($self, wxID_ANY, _T("Controleer automatisch op nieuwe versies"), wxDefaultPosition, wxDefaultSize, );
    $self->{cx_errorpopup} = Wx::CheckBox->new($self, wxID_ANY, _T("Popup window voor foutboodschappen"), wxDefaultPosition, wxDefaultSize, );
    $self->{cx_warnpopup} = Wx::CheckBox->new($self, wxID_ANY, _T("Popup window voor waarschuwingen"), wxDefaultPosition, wxDefaultSize, );
    $self->{cx_infopopup} = Wx::CheckBox->new($self, wxID_ANY, _T("Popup window voor mededelingen"), wxDefaultPosition, wxDefaultSize, );
    $self->{l_histlines} = Wx::StaticText->new($self, wxID_ANY, _T("Aantal te bewaren regels invoer historie:"), wxDefaultPosition, wxDefaultSize, );
    $self->{spin_histlines} = Wx::SpinCtrl->new($self, wxID_ANY, "200", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 99999, 200);
    $self->{sz_prefs_inner_staticbox} = Wx::StaticBox->new($self, wxID_ANY, _T("Voorkeuren") );
...
sub __set_properties {
    ...
    $self->{cx_updatecheck}->SetValue(1);
...
sub __do_layout {
    ...
    $self->{sz_prefs_inner_staticbox}->Lower();
    ...
    $self->{sz_prefs}->Add($self->{cx_updatecheck}, 0, wxADJUST_MINSIZE, 0);
